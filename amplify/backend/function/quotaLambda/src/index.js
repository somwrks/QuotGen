/* Amplify Params - DO NOT EDIT
	API_QUOTA_GRAPHQLAPIIDOUTPUT
	API_QUOTA_QUOTEAPPDATATABLE_ARN
	API_QUOTA_QUOTEAPPDATATABLE_NAME
	ENV
	REGION
Amplify Params - DO NOT EDIT */
...
async function updateQuoteobject(){
    const qtname = process.env.API_QUOTA_QUOTEAPPDATATABLE_NAME;
    const qobjectid = "12232-234234-23423-234-234234234"
    ...
    var quoteparam = {
        ...
        UpdateExpression: "SET #qutesGenerated = #quotesGenerated + :inc",
        ExpressionAttributeNames:{
            "#quotesGenerated" : "quotesGenerated"
        },
        ReturnValues : "UPDATED_NEW"
    }
    const updateQuoteobject = await docClient.update(quoteparam).promise()
